...
<head>
    ...
    <style>
        ...
        header{
            ...
            z-index: 800;
            box-shadow: 0 .5rem 1rem tgba(0,0,0,.1);
        }

        .image-container {
            margin-right: 5px !important; /* Kurangi jarak antara gambar dan container */
        }

        .container-wrapper {
            display: flex;
            justify-content: flex-start; /* Letakkan elemen di awal */
            align-items: center; /* Sejajarkan vertikal */
            gap: 10px !important; /* Kurangi jarak antar elemen */
            padding: 20px;
        }


        .image-container img {
            max-width: 800px; /* Atur lebar maksimum gambar */
            height: auto; /* Menjaga proporsi gambar */
            border-radius: 10px; /* Opsional: membuat sudut melengkung pada gambar */
            margin-left: 100px;
        }

        .container {
            max-width: 460px;
            margin-left: auto; /* Memastikan container sejajar kanan */
            margin-right: 150px; /* Tambahkan jarak dari kanan jika diperlukan */
...
<body>
    <header>
        ...
        <!-- <a class="logo">BliBli<span>.Com.</span></a> -->
        <div class="icons">
    ...
    <div class="container-wrapper d-lg-flex">
        <div class="image-container">
            <img src="gambar/blibli.png" alt="Gambar Pembayaran" class="img-fluid">
        </div>
