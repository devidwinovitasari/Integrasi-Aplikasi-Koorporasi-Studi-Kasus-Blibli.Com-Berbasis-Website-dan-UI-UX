...
<header>
    ...
    <a href="index.php" class="logo">BliBli.Com<span>.</span></a>
    <div class="icons">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
                    ...
                    <a href="#">
                        <img src="gambar/produk1.jpg" class="card-img-top rounded-2">
                    </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
                    ...
                    <a href="#">
                        <img src="gambar/produk2.jpg" class="card-img-top rounded-2">
                    </a>
                    <div class="card-body d-flex flex-column pt-3 border-top">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
                    ...
                    <a href="#">
                        <img src="gambar/produk3.jpg" class="card-img-top rounded-2">
                    </a>
                    <div class="card-body d-flex flex-column pt-3 border-top">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
                    ...
                    <a href="#">
                        <img src="gambar/produk4.jpg" class="card-img-top rounded-2">
                    </a>
                    <div class="card-body d-flex flex-column pt-3 border-top">
