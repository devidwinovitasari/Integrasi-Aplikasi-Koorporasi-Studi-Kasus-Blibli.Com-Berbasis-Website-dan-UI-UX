...
$total_produk = $total_pesanan = $total_pelanggan = 0;
...
<head>
    ...
    <style>
            ...
            * {
            ...
            body {
                background-image: url('blibli.jpg') no-repeat;
            }
            ...
            .main-content {
                margin-left: 250px;
                background: url(blibli.jpg) no-repeat center center/cover;
...
<div class="main-content">
    <header>
        ...
        <div class="user-wrapper">
            <img src="Devi.png" width="40px" height="40px">
            <div>
                <h4>Admin</h4>
                <small>Admin BliBli.Com</small>
            </div>
        </div>
    </header>
